...
export declare function param_r_(arg_a:string[], param_dfn_r_param_name?:param_name_r_param_dfn_T, default_value_r_param_name?:param_r_default_value_r_param_name_T):param_r_T;
